...
body += "<select id='serie' class='area'>" + "<option disabled selected>" + "Informe a serie" + "</option>" + "<option>" + "1° A " + "</option>" + "</option>" + "<option>" + "1° B " + "</option>" + "<option>" + "2° A " + "</option>" + "<option>" + "2° B " + "</option>" + "<option>" + "3° A " + "</option>" + "<option>" + "3° B " + "</option>"  + "</select>"
